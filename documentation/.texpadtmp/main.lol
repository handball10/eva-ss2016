...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5.1}submit Methode im customer Controller}{18}{lstlisting.5.1}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5.2}Validierung der Personenanzahl im View}{21}{lstlisting.5.2}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5.3}Aktualisierungscode nach einem Drag n Drop-Event}{24}{lstlisting.5.3}
\defcounter {refsection}{0}\relax 
\contentsline {chapter}{\numberline {6} {Backend}}{}{} 
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {6.1}Beispiel-Konfiguration f\IeC {\"u}r Datenbankzugriffe}{28}{lstlisting.6.1}
\defcounter {refsection}{0}\relax 
