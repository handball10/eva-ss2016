...
%Glossar
\usepackage[xindy,toc, automake]{glossaries} % nomain, if you define glossaries in a file, and you use \include{INP-00-glossary}
...
\input{settings/fontsPenaltiesMargins}
