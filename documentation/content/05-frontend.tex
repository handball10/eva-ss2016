...
\section{Kalender}
Der Kalender ist der Hautbestandteil der Anwendung (Abbildung \ref{frontend_mainpage}). Auf ihm kann der Benutzer alle Buchungen einsehen und editieren. Hinzu kommt die Verwaltung der Mietobjekte.
