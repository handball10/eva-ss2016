...
%TODO write something about the structur
...
\begin{figure}[H]
\centering\includegraphics[width=0.8\textwidth]{images/frontend_login.png}
...
Wird ein Dialog bestätigt wird erscheint für drei Sekunden am oberen rechten Fensterrand ein Nachricht. Ein sogenannter Toast fährt herunter und zeigt die Erfolgsmeldung und einen Button zum schließen an.  
